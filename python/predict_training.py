...
net = caffe.Net(caffe_root + 'workspace/SR-2x/SRCNN_deploy_training.prototxt',
                       caffe_root + 'workspace/SR-2x/SRCNN_iter_1440288')
...
# Inputs
im_raw = cv2.imread('/home/solesschong/workspace/caffe-master/data/SR_NE_ANR/Training/t1.bmp')
